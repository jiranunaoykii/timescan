...
GO
PRINT N'Creating [dbo].[AbsenceSet]...';
...
CREATE TABLE [dbo].[AbsenceSet] (
    ...
    CONSTRAINT [PK_AbsenceSet] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
CREATE NONCLUSTERED INDEX [IX_FK_EmployeeAbsence]
    ON [dbo].[AbsenceSet]([EmployeeCode] ASC);
...
CREATE TABLE [dbo].[EmployeeSet] (
    ...
    CONSTRAINT [PK_EmployeeSet] PRIMARY KEY CLUSTERED ([EmployeeCode] ASC)
);
...
CREATE NONCLUSTERED INDEX [IX_FK_EmployeeTimeScan]
    ON [dbo].[TimeScanSet]([EmployeeCode] ASC);
...
ALTER TABLE [dbo].[AbsenceSet]
    ADD CONSTRAINT [FK_EmployeeAbsence] FOREIGN KEY ([EmployeeCode]) REFERENCES [dbo].[EmployeeSet] ([EmployeeCode]);
...
ALTER TABLE [dbo].[TimeScanSet]
    ADD CONSTRAINT [FK_EmployeeTimeScan] FOREIGN KEY ([EmployeeCode]) REFERENCES [dbo].[EmployeeSet] ([EmployeeCode]);
