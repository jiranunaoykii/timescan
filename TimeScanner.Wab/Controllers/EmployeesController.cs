...
namespace TimeScanner.Wab.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EmployeeCode,PID,TitleName,FirstName,LastName,Position,Email,Tel")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EmployeeCode,PID,TitleName,FirstName,LastName,Position,Email,Tel")] Employee employee)
        {
            if (ModelState.IsValid)
            {
